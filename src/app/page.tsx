    ...
    <div style={{ background: 'var(--color-bg)', color: 'var(--color-text)' }}>
      ...
      <section id="features" className="py-24 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: '🔐', title: '인증 시스템', desc: '로그인/회원가입 UI와 기본 로직이 포함되어 있습니다', link: '/login' },
              { icon: '💳', title: '결제 시스템', desc: '결제 페이지와 관리 화면이 준비되어 있습니다', link: '/admin/payments' },
      ...
      <section className="py-24 px-4" style={{ background: 'var(--color-bg-secondary)' }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold mb-4">
              모든 <span style={{ color: 'var(--color-accent)' }}>페이지</span> 둘러보기
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { name: '로그인', href: '/login', desc: '로그인' },
              { name: '회원가입', href: '/signup', desc: '회원가입' },
              { name: '대시보드', href: '/dashboard', desc: '사용자 대시보드' },
              { name: 'AI 도구', href: '/dashboard/ai', desc: 'AI 기능' },
